...
public class WorkQueue {
	...
	/**
	 * Tracks unfinished work and implement the finish() method to wait until there
	 * is no more pending work.
	 */
	private volatile int pending;

	/**
	 * lock to protect the pending variable
	 */
		...
		synchronized (pendingLock) {
			while (pending > 0) {
				try {
					...
					System.err.println("Warning: Interrupted while waiting on pending work.");
